...
procedure TTestEd448.InvalidPublicKeyFull(const ASPK: String);
begin
  CheckFalse(TEd448.ValidatePublicKeyFull(DecodeHex(ASPK), 0), ASPK);
end;

procedure TTestEd448.InvalidPublicKeyPartial(const ASPK: String);
begin
  CheckFalse(TEd448.ValidatePublicKeyPartial(DecodeHex(ASPK), 0), ASPK);
end;

procedure TTestEd448.ValidPublicKeyPartial(const ASPK: String);
begin
  CheckTrue(TEd448.ValidatePublicKeyPartial(DecodeHex(ASPK), 0), ASPK);
end;
