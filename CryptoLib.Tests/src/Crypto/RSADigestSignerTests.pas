...
begin
  rsaPubMod := TBigInteger.Create(1, TBase64Encoder.Decode(
  ...
  rsaPubExp := TBigInteger.Create(1, TBase64Encoder.Decode('EQ=='));

  rsaPrivMod := TBigInteger.Create(1, TBase64Encoder.Decode(
    'AIASoe2PQb1IP7bTyC9usjHP7FvnUMVpKW49iuFtrw/dMpYlsMMoIU2jupfifDpdFxIktSB4P+6Ymg5WjvHKTIrvQ7SR4zV4jaPTu56Ys0pZ9EDA6gb3HLjtU+8Bb1mfWM+yjKxcPDuFjwEtjGlPHg1Vq+CA9HNcMSKNn2+tW6qt'));
  rsaPrivExp := TBigInteger.Create(1, TBase64Encoder.Decode(
