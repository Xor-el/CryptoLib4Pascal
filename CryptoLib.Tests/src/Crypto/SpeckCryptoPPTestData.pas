...
type
  /// <summary>
  /// Multi-block Speck test vectors from Crypto++ (speck.txt).
  /// </summary>
  TSpeckCryptoPPTestData = class sealed
  public
    class var
      Keys64Ecb, Inputs64Ecb, Outputs64Ecb: TCryptoLibStringArray;
      Keys128Ecb, Inputs128Ecb, Outputs128Ecb: TCryptoLibStringArray;
      Keys64Cbc, Ivs64Cbc, Inputs64Cbc, Outputs64Cbc: TCryptoLibStringArray;
      Keys128Cbc, Ivs128Cbc, Inputs128Cbc, Outputs128Cbc: TCryptoLibStringArray;
      Keys64Ctr, Ivs64Ctr, Inputs64Ctr, Outputs64Ctr: TCryptoLibStringArray;
      Keys128Ctr, Ivs128Ctr, Inputs128Ctr, Outputs128Ctr: TCryptoLibStringArray;
...
{ TSpeckCryptoPPTestData }

class constructor TSpeckCryptoPPTestData.Create;
begin
  // https://github.com/weidai11/cryptopp/blob/master/TestVectors/speck.txt

  Keys64Ecb := TCryptoLibStringArray.Create
    ('F64F824BDA9DA2D0D446ABE3', '64B76FA61CE980AB2F71098D75D66E5F');
  Inputs64Ecb := TCryptoLibStringArray.Create
    ('48731C8BFE3260D4', '1589A8BBFF4C7A85');
  Outputs64Ecb := TCryptoLibStringArray.Create
    ('55CABA8DE9F967C8', '2F1D122370946BDA');

  Keys128Ecb := TCryptoLibStringArray.Create
  ...
  Outputs64Cbc := TCryptoLibStringArray.Create
  ...
  Keys128Cbc := TCryptoLibStringArray.Create
  ...
  Outputs128Cbc := TCryptoLibStringArray.Create
  ...
  Keys64Ctr := TCryptoLibStringArray.Create
    ('C72CBD543750780FBCD5CB64', 'D0F15E55870DD39236C0251C438F57B4');
  Ivs64Ctr := TCryptoLibStringArray.Create
    ('E4FE17997B0F8028', '6942E2B8C46D5374');
  Inputs64Ctr := TCryptoLibStringArray.Create
  ...
  Outputs64Ctr := TCryptoLibStringArray.Create
  ...
  Keys128Ctr := TCryptoLibStringArray.Create
  ...
  Outputs128Ctr := TCryptoLibStringArray.Create
