...
begin
  LS := THexEncoder.Decode('00F50B028E4D696E676875615175290472783FB1');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('002757A1114D696E6768756151755316C05E0BD4');
  LBaseCurve := TFpCurve.Create(TSecNamedCurves.FromHex('DB7C2ABF62E35E668076BEAD208B'),
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('000E0D4D696E6768756151750CC03A4473D03679');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('004D696E67687561517512D8F03431FCE63B88F4');
  LBaseCurve := TFpCurve.Create(TSecNamedCurves.FromHex('FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF'),
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('1053CDE42C14D696E67687561517533BF3F83345');
  LBaseCurve := TFpCurve.Create(TSecNamedCurves.FromHex
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('B99B99B099B323E02709A4D696E6768756151751');
  LBaseCurve := TFpCurve.Create(TSecNamedCurves.FromHex
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('BD71344799D5C7FCDC45B59FA3B9AB8F6A948BC5');
  LBaseCurve := TFpCurve.Create(TSecNamedCurves.FromHex
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('10E723AB14D696E6768756151756FEBF8FCB49A9');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('10C0FB15760860DEF1EEF4D696E676875615175D');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('4D696E676875615175985BD3ADBADA21B43A97E2');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('985BD3ADBAD4D696E676875615175A21B43A97E3');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('24B7B137C8A14D696E6768756151756FD0DA2E5C');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('85E25BFE5C86226CDB12016F7553F9D0E693A268');
  LBaseCurve := TF2mCurve.Create(163, 3, 6, 7, TBigInteger.One,
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('103FAEC74D696E676875615175777FC5B191EF30');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('10B7B4D696E676875615175137C8A16FD0DA2211');
  LBaseCurve := TF2mCurve.Create(193, 15, TSecNamedCurves.FromHex
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('74D59FF07F6B413D0EA14B344B20A2DB049B50C3');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('77E2B07370EB0F832A6DD5B62DFC88CD06BB84BE');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('4099B5A457F9D69F79213D094C4BCD4D4262210B');
...
var
  ...
  LS: TCryptoLibByteArray;
begin
  LS := THexEncoder.Decode('2AA058F73A0E33AB486B0F610410C53A7F132310');
