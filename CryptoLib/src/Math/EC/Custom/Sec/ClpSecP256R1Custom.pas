...
type
  TSecP256R1Curve = class sealed(TAbstractFpCurve, IAbstractFpCurve, IECCurve,
    IECCTMultiplierFactory, ISecP256R1Curve)
  strict private
  const
...
function TSecP256R1Curve.CreateCTMultiplier(ABlindBits: Int32): IECMultiplier;
var
  LCurve: IECCurve;
...
begin
  ...
  Result := TFpCTMultiplier<TSecP256R1FieldArith>.Create(LFieldOps, ABlindBits);
end;
...
begin
  ...
  FParams.CtxData[1] := 4;
  LoadModulus(PCardinal(@TSecP256R1Field.P[0]), 8, @FParams.CtxData[2]); // p0..p3
