...
resourcestring
  ...
  SFailedToReadCertificate = 'failed to read certificate: %s';
...
class function TX509CertificateParser.GetTaggedPkcsSignedData(const ATagged: IAsn1TaggedObject; AState: Boolean): IPkcsSignedData;
begin
...
begin
  ...
  try
    ...
    on E: ECertificateCryptoLibException do
      raise;
    on E: Exception do
      raise ECertificateCryptoLibException.CreateResFmt(@SFailedToReadCertificate, [E.Message]);
  end;
end;
