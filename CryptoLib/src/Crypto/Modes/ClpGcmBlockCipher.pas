...
var
  ...
  LBufLen, LThresh2, LThresh4: Int32;
...
{$IFDEF CRYPTOLIB_X86_SIMD}
    if TGcmBlockCipher.IsFourWaySupported and (ALen >= BlockSize * 4) then
    begin
...
{$IFDEF CRYPTOLIB_X86_SIMD}
    if TGcmBlockCipher.IsFourWaySupported and (ALen >= LThresh4) then
    begin
