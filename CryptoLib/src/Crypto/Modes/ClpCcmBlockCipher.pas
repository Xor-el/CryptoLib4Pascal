...
type
  ...
  var
    ...
    FCcmKernel: IAcceleratedCcmKernel;
...
var
  ...
  LDirection: TAcceleratedKernelDirection;
begin
  ...
  begin
    ...
    if AForEncryption then
      LDirection := TAcceleratedKernelDirection.Encrypt
    else
      LDirection := TAcceleratedKernelDirection.Decrypt;
    TAcceleratedKernelRegistry.TryAcquireCcm(FCipher, LDirection, FCcmKernel);
  end;
